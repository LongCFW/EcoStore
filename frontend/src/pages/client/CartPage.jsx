...
const CartPage = () => {
    ...
    return (
      <Container className="py-5 text-center" style={{ minHeight: "60vh" }}>
        <div className="mb-4 opacity-50">
          <FaSignInAlt size={80} className="text-secondary" />
        </div>
  ...
  if (validCartItems.length === 0) {
    return (
      <Container className="py-5 text-center" style={{ minHeight: "60vh" }}>
        <div className="mb-4 opacity-50">
          <FaShoppingCart size={80} className="text-secondary" />
        </div>
        ...
        <Row>
          ...
          <Col lg={8}>
            ...
            <div className="d-flex flex-column gap-3">
              {validCartItems.map((item) => {
                ...
                return (
                  <Card
                    key={product._id}
                    className={`border-0 shadow-sm overflow-hidden ${isSelected ? "border-success border-2" : ""}`}
                  >
                      ...
                      <Row className="align-items-center">
                        ...
                        <Col xs={8} md={9}>
                          <div className="d-flex justify-content-between align-items-start mb-2">
                            <div>
                              <h6 className="fw-bold mb-1">
                                <Link
                                  ...
                                  className="text-dark text-decoration-none text-truncate-2-lines"
                                >
                                  {product.name}
                                </Link>
                              </h6>
                            ...
                            <button
                              className="btn btn-light text-danger rounded-circle p-2 btn-sm"
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            ...
                            >
                              ...
                              <input
                                type="text"
                                className="form-control border-0 text-center bg-white p-0 fw-bold"
                                value={item.quantity}
                                readOnly
                              />
                              <button
            ...
            <div className="mt-4">
              <Link
                to="/products"
                className="text-decoration-none text-muted d-inline-flex align-items-center gap-2 hover-green"
              >
                  ...
                  {subtotal > 0 && (
                    <>
                      {subtotal < FREESHIP_THRESHOLD ? (
                        ...
                        <p className="mb-1 small text-success fw-bold">
                          <FaCheckCircle className="me-1" /> Đơn hàng được
                          Freeship!
                        </p>
                      )}
                      <ProgressBar
