...
import { FaCamera, FaSave, FaUser, FaPhoneAlt, FaEnvelope, FaKey, FaLock } from "react-icons/fa";
...
const ProfileInfo = () => {
  ...
  return (
    <div className="profile-content-card animate-fade-in">
        ...
        {/* THÔNG BÁO CHUNG */}
        {status.show && <Alert variant={status.type} className="mb-4 shadow-sm">{status.msg}</Alert>}
        ...
        <div className="text-center mb-5 position-relative">
            <div className="avatar-container">
                ...
                <label className="avatar-upload-btn cursor-pointer" onClick={() => fileInputRef.current.click()}>
                    <FaCamera size={14}/>
                </label>
                <input 
                    type="file" 
            ...
            <p className="text-muted small mt-2">Nhấn vào icon máy ảnh để thay đổi.</p>
        </div>
        ...
        <Form>
          ...
          <div className="text-end pt-3 mb-5 border-top">
              <Button variant="success" onClick={handleSaveInfo} className="px-5 py-2 rounded-pill fw-bold shadow-sm d-inline-flex align-items-center gap-2">
        ...
        <h4 className="fw-bold mb-4 pb-3 border-bottom text-danger mt-5">
            <FaLock className="me-2 mb-1"/>Đổi mật khẩu
        </h4>
            ...
            <Row className="g-3">
                <Col md={12}>
                    <Form.Group className="mb-3">
                        ...
                        <div className="input-group">
                            <span className="input-group-text bg-white border-end-0"><FaKey className="text-muted"/></span>
                            <Form.Control 
                                type="password" 
                                name="current" 
                                value={pass.current} 
