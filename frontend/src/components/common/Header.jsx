  ...
  return (
    <>
      ...
      >
        <Container>
          ...
          <Navbar.Brand
            as={Link}
            to="/"
            className="fw-bold fs-3 d-flex align-items-center gap-2 me-3 me-lg-4"
          >
          ...
          >
            ...
            <div className="nav-item dropdown custom-nav-dropdown me-3">
              ...
              <div
                className="custom-dropdown-menu shadow rounded-4 border-0 py-2 mt-2"
            ...
            <div className="flex-grow-1 me-lg-4" style={{ maxWidth: "500px" }}>
              ...
              >
                ...
                <Button
                  type="submit"
                  variant="link"
                  className="position-absolute top-50 end-0 translate-middle-y text-success pe-3"
                >
                  <FaSearch />
                </Button>
              </Form>
            ...
            <div className="d-flex align-items-center gap-3 ms-auto">
              <Nav className="d-flex gap-3 fw-medium align-items-center me-2">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "text-success text-decoration-none fw-bold"
                      : "text-dark text-decoration-none hover-green"
                  }
                >
                  Trang chủ
                </NavLink>
              ...
              <div className="d-flex align-items-center gap-2">
                <Link
                  to="/cart"
                  className="position-relative btn btn-light rounded-circle shadow-sm d-flex align-items-center justify-content-center text-success cart-icon-hover"
                ...
                <Dropdown align="end">
                  ...
                  >
                    <div
                      className="btn btn-light rounded-circle d-flex align-items-center justify-content-center shadow-sm user-icon-hover border border-success overflow-hidden"
                  ...
                  <Dropdown.Menu
                    className="border-0 shadow-lg p-2 mt-3 rounded-4 animate-slide-up"
                    style={{ minWidth: "240px" }}
                  >
                    {isLoggedIn ? (
                      <>
                        ...
                        {isAdminOrStaff && (
                          <>
                            <Dropdown.Item
                              as={Link}
                              to="/admin"
                              className="rounded-2 py-2 mb-1 fw-bold text-success bg-success bg-opacity-10"
                            >
                              <FaCog className="me-2" /> Trang Quản Trị
                            </Dropdown.Item>
                            <Dropdown.Divider />
                          </>
                        )}
                        ...
                        >
                          <FaUserCircle className="me-2 text-success" /> Tài
                          khoản
                        </Dropdown.Item>
                        <Dropdown.Item
                          as={Link}
                          ...
                          className="rounded-2 py-2 mb-1 fw-medium"
                        >
                          <FaBoxOpen className="me-2 text-primary" /> Đơn mua
                        </Dropdown.Item>
                        <Dropdown.Item
                          as={Link}
                        ...
                        <Dropdown.Item
                          onClick={logout}
                          className="text-danger rounded-2 py-2 fw-bold"
                        >
                      ...
                      <>
                        <div className="px-3 py-2 text-center">
                          ...
                          <small className="text-muted">
                            Đăng nhập để mua sắm dễ dàng hơn
                          </small>
                        </div>
                        <div className="p-2 d-grid gap-2">
                          <Button
                            ...
                            to="/login"
                            variant="success"
                            className="rounded-pill fw-bold btn-sm shadow-sm"
                          >
                          ...
                          <Button
                            ...
                            className="rounded-pill fw-bold btn-sm"
                          >
      ...
      <Offcanvas
        ...
        placement="end"
        className="border-0 rounded-start-4"
      >
              ...
              <div className="d-grid gap-2">
                {isAdminOrStaff && (
                  <Button
                    ...
                    to="/admin"
                    variant="success"
                    className="justify-content-center d-flex align-items-center gap-2 py-2 rounded-pill fw-bold shadow-sm mb-2"
                  >
                    <FaCog /> Vào Trang Quản Trị
                  </Button>
                )}
                <Button
                  as={Link}
                  ...
                  className="justify-content-center d-flex align-items-center gap-2 py-2 rounded-pill"
                >
